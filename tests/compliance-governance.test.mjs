...
const html=fs.readFileSync(new URL("../tools/compliance-identification.html",import.meta.url),"utf8");assert.match(html,/不构成法律意见/);assert.match(html,/建议复核/);assert.match(html,/databaseCount/);assert.match(html,/application\/ld\+json/);assert.match(fs.readFileSync(new URL("../tools/regulations.html",import.meta.url),"utf8"),/立即进行智能识别/);
